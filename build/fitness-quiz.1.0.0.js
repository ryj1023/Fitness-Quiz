...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fitness = __webpack_require__(1);
	
	var fitness = _interopRequireWildcard(_fitness);
	...
	$(document).ready(function () {
	  ...
	  $('.startButton').click(function () {
	    $('.johnny').fadeOut(200, function () {
	      $('.johnny2').fadeIn(200);
	    });
	    $('#introDisplay').fadeOut(200, function () {
	      $('#question1').fadeIn();
	    });
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var questions = exports.questions = [{ question: "Which macronutrient contains amino acids?", answers: ["Protein", "Carbohydrates", "Fats", "Sugar"], correctAnswer: 0 }, { question: "Which exercise directly targets the bicep?", answers: ['Pulldown', "Pushup", "Curl", "Flat Press"], correctAnswer: 2 }, { question: "When is the best time to consume a protein shake?", answers: ["Before a workout", "After a workout", "During a workout", "Never"], correctAnswer: 1 }, { question: "What should you always do first when you are working out?", answers: ["Sprint", "Eat", "Stretch", "Sleep"], correctAnswer: 2 }, { question: "How long should you wait until working out the same muscle again?", answers: ["A few hours", "A day", "2-3 days", "2 weeks"], correctAnswer: 2
	}];
	...
	function userSelect() {
		...
		for (var i = 0; i < $('input[name="choice"]').length; i++) {
			...
			if ($('input[name="choice"]')[i].checked) checked++;
		}
		...
		if (input.checked) {
			exports.correctAnswers = correctAnswers += 1;
...
/***/ }
/******/ ]);
//# sourceMappingURL=fitness-quiz.1.0.0.js.map